	...
	<div id='container_fluid' class='container-fluid'> 
		<div class='container'> 
			...
			<% } %>
				...
				<form action="studentlogin.do" method='post' style="max-width:500px;margin:auto">
						
				 <div class="imgcontainer">
				 <img id='login_pic' src="static/image/login.png" >
				 </div>

					  <h2 style='color:#00154f;font-weight:bold;'>Student Login Form</h2>
					  ...
					  <div class="input-container" style='margin:auto;padding:0px 400px 0px 400px;'>
						<button class="btn"><a style='color:white' href="studentshowsignup.do">CREATE NEW ACCOUNT</a></button>
					  </div>
			</div>
