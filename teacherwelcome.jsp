...
<html lang="en">
 <head>
  ...
  <title>WELCOME PAGE SIGN-UP</title>
	  <style>
		#container_fluid{
 ...
 <body>
	<div id='container_fluid' class='container-fluid'> 
		<div class='container'> 
			...
			<span style='margin:auto;'><h5 style='font-weight:bold;color:#00154f'>THANKS FOR YOUR REGISTRATION. PLEASE CHECK YOUR GMAIL INBOX FOR CONFIRMATION YOUR ACCOUNT. 
			</h5></span>

			<div class="input-container" style='margin:auto;padding:0px 400px 0px 400px;'>
						<button class="btn"><a style='color:white' href="teachershowlogin.do">CLICK HERE FOR LOGIN</a></button>
			</div>
